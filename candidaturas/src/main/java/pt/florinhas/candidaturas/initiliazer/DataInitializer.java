...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        if (formRepository.count() > 0 || candidaturaRepository.count() > 0) {
            log.info("[DataInitializer] Dados já existem — seed ignorado.");
            return;
        }

        log.info("[DataInitializer] A inicializar dados de exemplo...");

        // ----------------------------------------------------------------
        // Form 1 — Candidatura a Bolsa de Investigação
        // ----------------------------------------------------------------
        Form form1 = new Form();
        ...
        form1.setSchema(Map.of(
            ...
            "properties", Map.of(
                ...
                "areaInvestigacao",Map.of("type", "string",  "title", "Área de Investigação"),
                "motivacao",       Map.of("type", "string",  "title", "Motivação",
                                          "description", "Descreva a sua motivação para esta bolsa.")
            )
        ));
        ...
        form2.setSchema(Map.of(
            ...
            "properties", Map.of(
                ...
                "disponibilidade",Map.of("type", "string",  "title", "Data de disponibilidade",
                                         "format", "date")
            )
        ));
        ...
        c1.setEstado(CandidaturaEstado.PENDENTE.name());
        c1.setCriadoPor(10L);
        ...
        c2.setEstado(CandidaturaEstado.APROVADA.name());
        c2.setCriadoPor(11L);
        ...
        c3.setEstado(CandidaturaEstado.REJEITADA.name());
        c3.setCriadoPor(12L);
