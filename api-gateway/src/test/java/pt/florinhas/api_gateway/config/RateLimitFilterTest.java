...
class RateLimitFilterTest {
    ...
    @Test
        void filter_DeveIgnorarGetNaoAuth() {
        ...
        @Test
        void filter_DeveAplicarRateLimitGlobalParaPostNaoAuth() {
        ...
        @Test
        void filter_DeveAplicarRateLimitPorIp() {
        ...
        MockServerWebExchange allowedExchange =
                MockServerWebExchange.from(
                        MockServerHttpRequest
                                .post("/api/auth/login")
                                .header(
        ...
        StepVerifier.create(
                filter.filter(allowedExchange, chain))
                .verifyComplete();

        assertEquals(
                null,
                allowedExchange.getResponse().getStatusCode());
        }
}