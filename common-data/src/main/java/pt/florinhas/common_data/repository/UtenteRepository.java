...
public interface UtenteRepository extends JpaRepository<Utente, Long> {
    ...
    // Pesquisa paginada com filtro opcional de nome
    @Query("SELECT u FROM Utente u WHERE (:nome IS NULL OR LOWER(u.nome) LIKE LOWER(CONCAT('%', :nome, '%')))")
    Page<Utente> findByNomeFilter(@Param("nome") String nome, Pageable pageable);
