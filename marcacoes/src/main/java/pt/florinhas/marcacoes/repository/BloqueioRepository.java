...
public interface BloqueioRepository extends JpaRepository<BloqueioAgenda, Long> {
     ...
     *
     * Método derivado pelo nome (Spring Data): traduz-se num SELECT por b.data = :data.
     *
     ...
     * return true se existir pelo menos um bloqueio que colide, false caso contrário
     */
