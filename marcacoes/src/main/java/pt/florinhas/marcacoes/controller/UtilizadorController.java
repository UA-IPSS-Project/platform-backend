...
/**
 * Controller responsável por operações de consulta e atualização de Utilizadores.
 *
 * Endpoints principais:
 *  - GET /api/utilizadores/{id}: obter utilizador por ID (formato DTO para o frontend)
 *  - GET /api/utilizadores/nif/{nif}: obter utilizador por NIF (objeto de domínio)
 *  - PUT /api/utilizadores/{id}: atualizar dados de perfil do utilizador
 *  - GET /api/utilizadores/utentes/count: contar utentes ativos (métrica para dashboards)
 *
 * Nota: a lógica de negócio reside em UtilizadorService; o controller apenas valida,
...
public class UtilizadorController {
    ...
    /**
     * Obtém um utilizador por ID e devolve um DTO adequado ao consumo pelo frontend.
     *
     ...
     * return 200 OK com UtilizadorResponseDTO atualizado; 400 em erro de validação/negócio
     */
