...
public class AuthController {
     ...
     * Cria um novo utilizador do tipo utente e devolve automaticamente um token de autenticação após o registo.
     ...
     * Cria um novo utilizador do tipo funcionário e devolve um token de autenticação associado.
     ...
     * Utiliza o objeto Authentication injetado pelo Spring Security para obter o utilizador associado ao token JWT enviado no pedido.
     * param authentication contexto de autenticação atual
     * return UserResponse com os dados do utilizador autenticado, ou 401 caso não exista autenticação válida
     */
    @GetMapping("/me")
