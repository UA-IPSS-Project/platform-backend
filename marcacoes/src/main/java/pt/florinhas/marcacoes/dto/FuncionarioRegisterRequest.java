 ...
 *
 * Características:
 *  - Imutável por definição (record): ideal para transporte de dados entre camadas.
 *  - Integra Bean Validation nas componentes, permitindo validação automática em controllers
...
public record FuncionarioRegisterRequest(
    ...
    // Contacto telefónico (obrigatório). Formato livre; validar formato se necessário. 
