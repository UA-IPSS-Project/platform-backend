...
public class AtualizarEstadoRequest {
     ...
     * Atenção: EventoEstado.valueOf é case-sensitive e lança IllegalArgumentException
    ...
    /**
     * Versão atual do registo (da entidade Marcacao), para controlo de concorrência otimista.
     * Deve ser enviada pelo cliente (e.g., obtida previamente no GET) e validada no update.
     */
     ...
     * throws IllegalArgumentException se 'novoEstado' não corresponder a um nome válido
     */
